...
- Voice Encoder/Decoder: Constructor validation, codec handling ([Opus](<https://en.wikipedia.org/wiki/Opus_(audio_format)>) only), ping packets, loopback mode, position data, error handling
